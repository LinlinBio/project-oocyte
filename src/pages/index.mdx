...
import oocyte-method from "../assets/oocyte-method.png"
import oocyte-1 from "../assets/oocyte-1.png"
import oocyte-2 from "../assets/oocyte-2.png"
...
<Figure>
  <Image slot="figure" source={oocyte-method} altText="Isolation and quality inspection of GV-stage mouse oocytes." />
...
<Figure>
  <Image slot="figure" source={oocyte-1} altText="Diagram of the transformer deep learning architecture." />
  <span slot="caption">Diagram of the transformer deep learning architecture.</span>
</Figure>

<Figure>
  <Image slot="figure" source={oocyte-2} altText="Diagram of the transformer deep learning architecture." />
  <span slot="caption">Diagram of the transformer deep learning architecture.</span>
</Figure>
